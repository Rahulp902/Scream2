					...
					<div class="col-md-6">												
						<form class="form-light mt-20" action="RegisterServlet" method="post"   >
							<div class="form-group">
								...
								<input type="text" class="form-control fn" placeholder="Full Name" name="name"  required>
							</div>
							<div class="form-group">
							...
							<!--  <div class="form-group">	
								...
								%></h3>
							 <div class="form-group">					
							<button type="submit" class="btn btn-two" onclick="return validate();">Register</button><p><br/></p>
 							<a href="Login.jsp" class="btn btn-two">Existing user login</a>
 							</div>
							 <div class="form-group">		
